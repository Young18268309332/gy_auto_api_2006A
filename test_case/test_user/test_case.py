...
自动生成 身份证号
'''
data5=excel_tool .get_test_case("D:\\pycharm\PyCharm2018.2.4\\auto-api-2006A\\test_case\\test_user\\充值接口测试数据(1).xlsx")

@pytest.mark.parametrize("account_name,money,expect",data5[1],ids=data5[0])
