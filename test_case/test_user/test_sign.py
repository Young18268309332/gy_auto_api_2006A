...
from tools.data.random_tool import random_tell, random_name, random_pwd
'''
...
def test_sign(pub_data):
    ...
    pub_data["userName"]="自动生成 字符串 4 数字 young"
    pub_data["phone"]="自动生成 手机号"
    pub_data["pwd"]="自动生成 字符串 4 数字 you"
...
def test_changepwd(pub_data):
    pub_data["newpwd"]="自动生成 字符串 5 数字 www"
    header={"token":pub_data["token"]}
